...
|---|---|---|---|---|---|---|
| <img src="../assets/img/apis/gemini.webp" alt="Gemini" width="72"> | Google Gemini API | https://ai.google.dev/gemini-api/docs | Tier gratuito o free trial con límites por proyecto | `gemini-2.5-flash`, `gemini-2.5-flash-lite` | No divulgado | Comparar un modelo cerrado de alto rendimiento contra Ollama local. |
